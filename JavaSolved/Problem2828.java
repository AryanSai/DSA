...
// of each string in words in order. For example, "ab" can be formed from ["apple", "banana"], but it
//  can't be formed from ["bear", "aardvark"].
...
public class Problem2828 {
    static boolean isAcronym(List<String> words, String s) {
        ...
        for (String word : words) {
            sol.append(word.charAt(0));
        }
        return s.equals(sol.toString());
    }
    ...
    public static void main(String[] args) {
        ...
        words.add("apple");
        // words.add("charlie");
        System.out.println(isAcronym(words,"a"));
    }
}
