...
// not need a ladder or bricks. If the current building's height is less than the next building's height,
...
// Output: 3
class Problem1642 {
    static int todo(int[] heights, int bricks, int ladders) {
        int i = 0;
    ...
    public static void main(String[] args) {
        int[] nums = { 1,5,1,2,3,4,10000 };
        System.out.println(todo(nums, 4, 1));
    }
}